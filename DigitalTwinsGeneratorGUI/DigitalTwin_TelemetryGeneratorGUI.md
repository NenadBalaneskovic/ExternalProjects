...
Microsoft. *PySide6 Documentation.*;  
Apache Arrow. *Parquet File Format Specification.*;  
NumPy Developers. *NumPy Reference Guide.*;  
Matplotlib Developers. *Matplotlib Plotting Library.*;
...
42. J. Frochte: "Finite-Elemente-Methode", Hanser 1st Ed.(2016);  D. Gross, W. Hauger, J. Schröder: "Technische Mechanik 1-3", 15th Ed. Springer (2024); 
